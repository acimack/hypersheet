...
export const CreateNodeModal = (props: ICreateNodeModalProps) => {
  ...
  const { isOpen, onClose, setSelectedNode, roots, nodeIdsToNodesMap, onSubmit } = props
  ...
  const handleSheetRowChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setSheetRows(event.target.value)
  }
  const handleSheetColChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setSheetCols(event.target.value)
  }
  ...
  switch (selectedType) {
    ...
    case 'image':
      ...
      break
    case 'sheet':
      contentInputPlaceholder = 'Blank sheet...'
      break
    default:
  ...
  const isSheet: boolean = selectedType === 'sheet'
      ...
      <div className="modal-font">
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            {selectedType && isSheet && (
              <div className="modal-input">
                <Input
                  value={sheetRows}
                  onChange={handleSheetRowChange}
            ...
            <div className="modal-section">
              ...
              <div className="modal-treeView">
                <TreeView
                  ...
                  setSelectedNode={setSelectedParentNode}
