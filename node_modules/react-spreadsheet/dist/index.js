...
var setCellData = toolkit.createAction("SET_CELL_DATA", function (active, data, getBindingsForCell) { return ({
    payload: { active: active, data: data, getBindingsForCell: getBindingsForCell },
}); });
var setCellDimensions = toolkit.createAction("SET_CELL_DIMENSIONS", function (point, dimensions) { return ({
...
var CornerIndicator = function () { return (React__namespace.createElement("th", { className: "Spreadsheet__header" })); };

var ColumnIndicator = function (_a) {
    var column = _a.column, label = _a.label;
    return (React__namespace.createElement("th", { className: "Spreadsheet__header" }, label !== undefined ? label : hotFormulaParser.columnIndexToLabel(String(column))));
};

var RowIndicator = function (_a) {
    var row = _a.row, label = _a.label;
    return (React__namespace.createElement("th", { className: "Spreadsheet__header" }, label !== undefined ? label : row + 1));
};
...
var reducer = toolkit.createReducer(INITIAL_STATE, function (builder) {
    builder.addCase(setData, function (state, action) {
        ...
        var nextBindings = map$1(function (bindings) {
            return filter(function (point) { return has$1(point, data); }, bindings);
        }, filter$1(function (_, point) { return has$1(point, data); }, state.bindings));
...
function clear(state) {
    ...
    return __assign(__assign(__assign({}, state), { data: selectedPoints.reduce(function (acc, point) { return set(point, undefined, acc); }, state.data) }), commit(changes));
}
function blur(state) {
...
var Cell = function (_a) {
    ...
    return (React__namespace.createElement("td", { ref: rootRef, className: classnames__default['default']("Spreadsheet__cell", data === null || data === void 0 ? void 0 : data.className, {
        ...
        React__namespace.createElement(DataViewer, { row: row, column: column, cell: data, formulaParser: formulaParser })));
};
var enhance = function (CellComponent) {
    return function CellWrapper(props) {
        ...
        var selected = useSelector(function (state) {
            return state.selected ? has$3(state.selected, { row: row, column: column }) : false;
        });
        var dragging = useSelector(function (state) { return state.dragging; });
        var copied = useSelector(function (state) {
            return has$2({ row: row, column: column }, state.copied);
        });
        ...
        return (React__namespace.createElement(CellComponent, __assign({}, props, { selected: selected, active: active, copied: copied, dragging: dragging, mode: mode, data: data, select: select$1, activate: activate$1, setCellDimensions: setCellDimensions$1 })));
    };
};
...
var ActiveCell = function (props) {
    ...
    return hidden ? null : (React__namespace.createElement("div", { ref: rootRef, className: classnames__default['default']("Spreadsheet__active-cell", "Spreadsheet__active-cell--" + mode), style: dimensions, onClick: mode === "view" && !readOnly ? edit : undefined, tabIndex: 0 }, mode === "edit" && active && (React__namespace.createElement(DataEditor, { row: active.row, column: active.column, cell: cell, 
        // @ts-ignore
...
var FloatingRect = function (_a) {
    ...
    return (React__namespace.createElement("div", { className: classnames__default['default']("Spreadsheet__floating-rect", (_b = {},
...
var Selected = function () {
    ...
    var dragging = useSelector(function (state) { return state.dragging; });
    var hidden = React__namespace.useMemo(function () { return isHidden(selected); }, [selected]);
...
var Spreadsheet = function (props) {
    var className = props.className, darkMode = props.darkMode, columnLabels = props.columnLabels, rowLabels = props.rowLabels, hideColumnIndicators = props.hideColumnIndicators, hideRowIndicators = props.hideRowIndicators, onKeyDown = props.onKeyDown, _a = props.Table, Table$1 = _a === void 0 ? Table : _a, _b = props.Row, Row$1 = _b === void 0 ? Row : _b, _c = props.HeaderRow, HeaderRow$1 = _c === void 0 ? HeaderRow : _c, _d = props.CornerIndicator, CornerIndicator$1 = _d === void 0 ? CornerIndicator : _d, _e = props.DataEditor, DataEditor$1 = _e === void 0 ? DataEditor : _e, _f = props.DataViewer, DataViewer$1 = _f === void 0 ? DataViewer : _f, _g = props.getBindingsForCell, getBindingsForCell$1 = _g === void 0 ? getBindingsForCell : _g, _h = props.RowIndicator, RowIndicator$1 = _h === void 0 ? RowIndicator : _h, _j = props.ColumnIndicator, ColumnIndicator$1 = _j === void 0 ? ColumnIndicator : _j, _k = props.onChange, onChange = _k === void 0 ? function () { } : _k, _l = props.onModeChange, onModeChange = _l === void 0 ? function () { } : _l, _m = props.onSelect, onSelect = _m === void 0 ? function () { } : _m, _o = props.onActivate, onActivate = _o === void 0 ? function () { } : _o, _p = props.onBlur, onBlur = _p === void 0 ? function () { } : _p, _q = props.onCellCommit, onCellCommit = _q === void 0 ? function () { } : _q;
    ...
    var _r = __read(reducerElements, 2), state = _r[0], dispatch = _r[1];
    ...
    var rootNode = React__namespace.useMemo(function () { return (React__namespace.createElement("div", { ref: rootRef, className: classnames__default['default']("Spreadsheet", className, {
